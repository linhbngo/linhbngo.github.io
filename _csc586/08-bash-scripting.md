...
toc:
  - name: Overview of Bash Script
  - name: Setup
  - name: Executing a bash script
  - name: Self-executing bash script
  - name: The Bash Language
  - name: Interactive Execution
  - name: Variables and Values
  - name: String operations
  - name: echo and printf
  - name: Other types and declarations
  - name: Command-line arguments
  - name: if-else statements
  - name: Program exit status
  - name: The && and || operators
  - name: Boolean expressions in test statements
  - name: Unary file information operators
  - name: Binary test operators
  - name: Subtle syntax issues
  - name: String patterns and the case statement
  - name: Loops
  - name: Reading lines in Bash
  - name: Command-line options
  - name: Built-in string processing operations
  - name: Functions
  - name: System command string processing
---
# Bash Scripting
...
Loops
One can use numerical-like looping with the double-parentheses like those in for numerical 
comparison:
