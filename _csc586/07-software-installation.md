...
toc:
  - name: Launch your CloudLab experiment
  - name: Overview
  - name: MySQL
  - name: Apache
  - name: PHP
  - name: PHP/phpmyadmin
  - name: Drupal
  - name: Challenge: Automating the process
---
...
{% details Configuring mysql-apt-config %}


- Press the `Tab` key to go to `Ok`, then press `Enter`

{% include figure.liquid path="assets/img/courses/csc586/08-software/mysql-01.png" width="50%" zoomable=true %}
...
{% enddetails %}
{% details Configuring mysql-community-server %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/mysql-02.png" width="50%" zoomable=true %}

- Select `User Strong Password Encryption (RECOMMENDED" width="50%" zoomable=true %}`
- Press the `Tab` key to go to `Ok`, then press `Enter`

{% include figure.liquid path="assets/img/courses/csc586/08-software/mysql-03.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/mysql-04.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/mysql-05.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/apache-01.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/phpmyadmin-01.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/phpmyadmin-02.png" width="50%" zoomable=true %}

{% include figure.liquid path="assets/img/courses/csc586/08-software/phpmyadmin-03.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/drupal-01.png" width="50%" zoomable=true %}

{% details Error: File system %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/drupal-02.png" width="50%" zoomable=true %}

{% enddetails %}
{% details Error: Settings File %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/drupal-03.png" width="50%" zoomable=true %}

{% enddetails %}
{% details Warnings: Clean URLS %}
...
{% include figure.liquid path="assets/img/courses/csc586/08-software/drupal-04.png" width="50%" zoomable=true %}
...
- [Ansible](https:/www.ansible.com/) is one of the more well-known 
configuration management tools at the disposal of sys admins. 
- This is to help facilitate the automatic installation and configuration 
of various software. 
- Tasks:
- Install Ansible on CloudLab experiment
- Follow instructions at [Digital Ocean](https:/www.digitalocean.com/community/tutorials/how-to-use-ansible-to-install-and-set-up-lamp-on-ubuntu-18-04) to setup 
