...
title: "More Bash Scriptings"
toc:
  - name: Pipes and Filters
  - name: Capturing output from commands
  - name: Filtering output
  - name: Passing output to another command
  - name: Nelle’s Pipeline: Checking Files
  - name: Loop
  - name: More complicated loop
  - name: Nelle's Pipeline: Processing Files
  - name: Shell scripting
  - name: Nelle's Pipeline: Creating a Script
---
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/pdb-list.png" width="50%" zoomable=true alt="List files in current directory" %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/wc-cli.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/wc-redirect.png" width="50%" zoomable=true %}
...
{% details Challenge: what does `sort -n` do? %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/sort-cli.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/head-cli.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/pipe-multiple.png" width="50%" zoomable=true %}

{% details Challenge: piping commands together %}
...
{% enddetails %}
{% enddetails %}
{% details Challenge: pipe reading comprehension %}
...
{% enddetails %}
{% enddetails %}
{% details Challenge: pipe construction %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/cut-pipe.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/loop-creatures.png" width="50%" zoomable=true alt="Viewing DNA contents of mystical creatures" %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/loop-classifications.png" width="50%" zoomable=true %} to match all files ending in `.pdb` and then 
  lists them using `ls`.
...
{% details Challenge: limiting sets of files %}
...
{% details Challenge: saving to a file in a Loop %}
...
{% details Those Who Know History Can Choose to Repeat It %}
...
{% enddetails %}
{% details Challenge: doing a dry run %}
...
{% enddetails %}
{% enddetails %}
{% details Challenge: nested loops %}
...
## Shell scripting
    ...
    {% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/script-middle.png" width="50%" zoomable=true %}
    

{% details Text vs. Whatever %}
...
{% include figure.liquid path="assets/img/courses/csc586/09-scripting-linux/script-arguments.png" width="50%" zoomable=true %}
...
{% details Challenge: list unique species %}
...
{% details Challenge: variables in shell scripts %}
...
{% enddetails %}
{% details Challenge: find the longest file with a given extension %}
...
{% enddetails %}
{% enddetails %}
{% details Challenge: script reading comprehension %}
...
{% enddetails %}
{% enddetails %}
{% details Challenge: debugging scripts %}
