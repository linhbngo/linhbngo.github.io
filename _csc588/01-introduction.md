...
title: "Introduction"
toc:
  - name: Fundamentals of access control
  - name: A brief history of access control
  - name: RBAC and the enterprise
---
# Introduction
...
{% details The purpose and fundamentals of access control %}

{% enddetails %}
- `Who can do what`. 
- Ways in which users can access resources in the computer systems. 

{% details Information security risks (CIA) %}
...
{% details Authorization versus authentication %}
...
{% details Department of Defense standards %}
...
{% details Formal description of RBAC %}
...
{% details Authorization management and resource provisioning %}
