...
{% details Presentations in software engineering %}
...
- Every team member must present a portion of one presentation
    - Less experienced presenters will be more comfortable 
    presenting things they personally worked on
...
- Good audio is essential
    - Make a practice recording with all presenters in their anticipated
    locations/positions
...
- Topics on agenda should serve purpose of meeting
    - Description of what you have agreed to deliver to your client 
...
- Slides
    ...
    - Must be legible
- Audience may have poor eyesight, projectors are lower 
resolution, screens are farther away
...
- Distribute handouts ahead of time, or after meeting, or else be 
explicit about when they should be referenced
...
- Never interrupt your colleagues
    - If you have information to add, raise your hand, allow presenter to 
    decide if/when to call on you
...
- Technical preparations:
    - Load and configure all software before presentation. Test it, 
    then change nothing
    - If you need test data or accounts, create them in advance
    - If complex commands must be typed, create a cheat sheet or shell 
    script. Ensure they work verbatim
- Prepare a script
