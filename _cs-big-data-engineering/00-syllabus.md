...
1. Be able to setup and deploy appropriate data engineering 
technologies to manage big data sets.
2. Be able to understand MapReduce, one of the key enabling 
...
other relevant disciplines to identify solutions (ABET 1).
