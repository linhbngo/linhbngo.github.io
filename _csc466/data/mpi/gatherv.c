...
int main(int argc, char *argv[]) {
    int rank, size, i; 
    int recvcounts[4] = {1,2,3,4}; /* process 0 will receive from each process that */
                                   /* process rank plus 1 numbers */
    int displs[4] = {0,0,0,0}; /* array describing the displacements where each segment */ 
                               /* begins and is initialized to all 0s */
