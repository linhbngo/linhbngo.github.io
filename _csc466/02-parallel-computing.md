...
toc:
  - name: A simple computation problem
  - name: Parallel and distributed computing systems
  - name: Can we just throw more computers at the problem?
  - name: Parallel and distributed computing system architectures
  - name: Benchmarking
---
...
{% enddetails %}
{% details Components of a computation problem %}
...
{% enddetails %}
{% details Computational tasks should be able to ... %}
...
{% enddetails %}
{% details Execution framework should be able to ... %}

- Execute multiple program instructions concurrently at any moment in time


{% enddetails %}
{% details Computing resources might be ... %}
...
{% enddetails %}
{% details How have parallel and distributed computing resources evolved? %}
...
the fraction that is non-parallelizable ($f\times t_s$) plus the remaining parallelizable
fraction ($1-f$). 
...
{% details What portion of my code is serial? %}
...
{% enddetails %}
{% details What is the speedup on 20 processors? %}
...
{% enddetails %}
{% details What is the efficiency on 5 processors? 20 processors? %}
...
{% enddetails %}
{% details What is the best speedup that I could achieve? %}
...
{% enddetails %}
{% enddetails %}
{% details Limiting factors of parallel speedup %}

- Non-parallelizable code.
- Communication overhead. 

{% enddetails %}
{% details If there is no limiting factor ... %}
...
{% details Types of distributed computing systems %}
...
{% enddetails %}
{% details GPU - graphics processing unit %}
...
{% enddetails %}
{% details Message passing distributed computing %}
