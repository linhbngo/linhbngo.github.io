...
The first pillar is **intentionality**. When you learn with AI, you have to be intentional. This goes back to what I said earlier about not putting your brain on cruise control. You set your learning goals (do not let them be the final answers for your assignments).  You need to ask AI explicitly to show you its reasoning and you need to reflect on this reasoning afterward. You want to be very mindful of mindless copy and paste. To be honest, even if you are typing the entire answer from AI into your document manually, I would argue that you would already have learned something from it, one way or the other. One example approach is for you to ask the AI to for hints (or even solutions) of a problem in plain English. After looking at these hints/solutions, you can go back to write as much of answer as you can reason/remember, then ask the AI to evaluate and analyze your answer for correctness and differences. 
