...
Did I try AI? Yes I did. The results were inconsistent and hard to validate. In this case, I think that the manual process that I am doing might take longer, but is certainly safer and more deterministic in a research context rather than using AI for data merging. Anyway, I am about 6,000 lines into my source data, and then I realize, there is nothing fancy about doing research at all. That said, why my students are so afraid of trying out research work. They perceive research as something high-level cognitive activities that require significant brain power. In this essay, I want to make the case that research is mainly about grunt work, perseverance, and the patience to throw cakes at the wall until some stick. 
