...
??? info "Essential Python Concepts"
...
!!!info "Types of Machine Learning"
...
???info "Supervised Learning Algorithms"
    **Supervised learning:** learning a function which approximates the relationship between an input and output from a set of labeled training examples.
    ...
    ![Home price data](fig/python_ml/img_sklearn/hp.png)
...
???info "Regression vs. Classification"
    ...
    ![regression](fig/python_ml/img_sklearn/reg.png)

    In the case of **classification**, we predict a *label* (i.e. a category).

    ![classification](fig/python_ml/img_sklearn/class.png)
...
![train_test](fig/python_ml/img_sklearn/tr_ts.png)
...
![cross_val](fig/python_ml/img_sklearn/cvl.png)
