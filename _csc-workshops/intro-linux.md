...
{% include figure.liquid path="fig/intro-linux/gui-cli-files.png" %}

{% enddetails %}
{% details example Hands-on: preparing shell and data %}
...
{% include figure.liquid path="fig/intro-linux/file_system_path.png" %}

{% enddetails %}
{% details note Hands-on: pwd, ls, cd %}
...
{% include figure.liquid path="fig/intro-linux/pwd.png" %}
...
{% include figure.liquid path="fig/intro-linux/ls.png" %}
...
{% include figure.liquid path="fig/intro-linux/ls-help.png" %}
...
{% include figure.liquid path="fig/intro-linux/ls-man.png" %}

{% details question Challenge: exploring more ls flags %}
...
{% enddetails %}
{% enddetails %}
{% details question Challenge: Listing in reverse chronological order %}
...
{% include figure.liquid path="fig/intro-linux/cd-shell.png" %}

{% details question Challenge: `ls` Reading comprehension %}
...
{% include figure.liquid path="fig/intro-linux/filesystem-challenge.svg" %}
...
{% enddetails %}
{% enddetails %}
{% details info General syntax of a shell command %}


{% include figure.liquid path="fig/intro-linux/shell_command_syntax.svg" %}
...
{% enddetails %}
{% details note Hands-on: explore data %}
...
{% details note Creating directories: mkdir %}
...
{% details question Challenge: creating multiple directories %}
...
{% enddetails %}
{% details note Creating files: nano (or vim) %}
...
{% include figure.liquid path="fig/intro-linux/nano.png" %}
...
{% details note Moving files and directories:  mv %}
...
{% details question Challenge: Moving files to a new folder %}
...
{% enddetails %}
{% enddetails %}
{% details note Copying files and directories: cp %}
...
{% details question Challenge: Renaming files %}
...
{% enddetails %}
{% enddetails %}
{% details question Challenge: Moving and copying %}
...
{% enddetails %}
{% enddetails %}
{% details note Removing files and directories: rm %}
...
{% include figure.liquid path="fig/intro-linux/wildcards.png" %}

{% details question Challenge: more on wildcards %}
