...
???note "Links to download and install Docker Desktop"
...
???note "Getting started"
    ...
    ![](fig/docker/docker-version.png)

???note "Overview of Docker"
...
???example "Hands-on: Hello world"
    ...
    ![](fig/docker/gui-container-image.png)
...
???example "Hands-on: Interactive container"
    ...
    ![](fig/docker/cli-docker-run-interactive.png)
    ...
    ![](fig/docker/cli-docker-run-figlet.png)


???question "Exercise: exit container"
    ...
    ???tip "Solution"
        ...
        ![](fig/docker/cli-docker-run-figlet-exercise.png)

???example "Hands-on: Background container"
    ...
    ![](fig/docker/cli-docker-run-date.png)
    ...
    ![](fig/docker/cli-docker-run-date-BG.png)
    ...
    ![](fig/docker/cli-docker-logs.png)
...
???note "The read-write layer"
    ![](fig/docker/rw-layer.png)

???note "Containers versus images"
    ...
    ![](fig/docker/container-image.png)
...
???note "How do we change an image?"
...
???example "Hands-on: listing local images and searching for new images"
    ...
    ![](fig/docker/docker-search.png)

???note "General steps to create an image"
    ...
    ![](fig/docker/image-create.png)


???example "Hands-on: create a container with a base distro"
    ...
    ![](fig/docker/image-create-container.png)
    ...
    ![](fig/docker/image-docker-diff.png)
...
???example "Hands-on: commit changes into a new image"
    ...
    ![](fig/docker/image-docker-commit.png)
...
???note "Automatic image construction: Dockerfile"
...
???example "Hands on: writing the first Dockerfile"
    ...
    ![](fig/docker/image-docker-build.png)
    ...
    ![](fig/docker/image-docker-push.png)

???question "Exercise: test new image"
    ...
    ???tip "Solution"
        ...
        ![](fig/docker/image-test-image.png)
...
???example "Hands on: CMD"
    ...
    ![](fig/docker/image-create-cmd.png)

???question "Exercise: storage consumption"
    - Run the following commands
    ...
    ![](fig/docker/image-storage.png)

???example "Hands on: ENTRYPOINT"
    ...
    ![](fig/docker/image-entrypoint.png)

???example "Hands on: Using both ENTRYPOINT and CMD"
    ...
    ![](fig/docker/image-cmd-entrypoint.png)
...
???example "Hands on: Importing and building external code using COPY"
    ...
    ![](fig/docker/image-docker-build-copy.png)

???example "Hands on: Mounting external storage to running containers"
    ...
    ![](fig/docker/image-volume.png)

## 6. Infrastucture as Code: Networking

???note "Networking for container"
...
???example "Hands on: A simple web server"
    ...
    ![](fig/docker/container-networking.png)
...
???example "Hands on: manual allocation of port numbers"
