...
toc:
  ...
  - name: Bit-level operations in  C
  - name: Encoding integers
  - name: Conversions (casting)
  - name: Addition, multiplication, and negation (of integers)
  - name: Byte-oriented memory organization
  - name: Fractional binary numbers (float and double)
...
{% details Hands-on: bit-level operations in C %}
...
{% details 2's complement examples %}
...
{% details What does it really mean by casting %}
...
{% details Visualization of conversions %}
...
{% details Expanding and truncation %}
...
{% details Misunderstanding integers can lead to the end of the world! %}
...
{% details Word-oriented memory organization %}
...
{% details Hands on: byte ordering in memory %}
...
{% details Importance of floating-point arithmetic accuracy %}
...
{% details IEEE Floating point representation %}
...
{% details note Three "kinds" of floating point numbers %}
...
{% details Normalized floating point numbers %}
...
{% details Example: normalized floating point numbers %}
...
{% details Hands on: check floating point representation %}
...
{% details Denormalized floating point %}
...
{% details Floating point multiplication %}
...
{% details Floating point addition %}
...
{% details Mathematical properties of floating point addition %}
...
{% details Mathematical properties of floating point multiplication %}
