...
{% include figure.liquid path="assets/img/courses/csc331/limited-direct-execution/limited_01.png" width="50%" zoomable=true %}
...
{% details Rephrase: The process **should be able to have its restricted operations performed** %}
...
- A small set of APIs for restricted operations.
    - [XV6 system calls](https://github.com/mit-pdos/xv6-riscv/blob/riscv/kernel/syscall.h)
...
{% include figure.liquid path="assets/img/courses/csc331/limited-direct-execution/limited_02.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc331/limited-direct-execution/04.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc331/limited-direct-execution/05.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc331/limited-direct-execution/limited_03.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc331/limited-direct-execution/06.png" width="50%" zoomable=true %}
{% enddetails %}
