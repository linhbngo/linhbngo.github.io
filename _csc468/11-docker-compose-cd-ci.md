...
{% include figure.liquid path="assets/img/courses/csc468/compose-cd-ci/hub-token-1.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc468/compose-cd-ci/hub-token-2.png" width="50%" zoomable=true %}

- Keep the page with the personal access token open, as we will need that for later. 

{% include figure.liquid path="assets/img/courses/csc468/compose-cd-ci/hub-token-3.png" width="50%" zoomable=true %}
...
{% include figure.liquid path="assets/img/courses/csc468/compose-cd-ci/hub-token-4.png" width="50%" zoomable=true %}

- Add the following secrets:
    - `DOCKERHUB_TOKEN`: your DockerHub login name
    - `DOCKERHUB_USERNAME`: The secret token generated by Docker Hub earlier. 

{% include figure.liquid path="assets/img/courses/csc468/compose-cd-ci/hub-token-5.png" width="50%" zoomable=true %}
