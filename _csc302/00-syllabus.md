...
Addison Wesley, ISBN-10: 0321-51294-4, ISBN-13: 978-0-321-51294-9.
...
This course will provide an introduction to critical and diverse topics 
in computer security, such as security requirements, attack models, 
cryptography, authentication, system security, etc.
...
1. Understand important topics of computer security, such as 
security concepts, principles, components, architectures, ethical 
and legal issues (CSPO 4)
2. Design, implement and evaluate a secure network 
system (CSPO 2)
3. Apply mathematical foundations, algorithm principles, and computer 
science theory in topics such as cryptographic operations and security 
architecture (CSPO 5)
4. Work effectively both independently and in teams through hands-on 
lab activities and team projects (CSPO 3)
5. Find technical information from the web and other sources when 
they do assignments and project (CSPO 3)
